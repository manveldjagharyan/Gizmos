...
var FeaturedProducts = [
    new Product('1', '4K Smart Monitor Vantablack Expo GPS-8377366J',
        ...
        '11', 'Gadgets', 'Computers, Equipment',
    ...
    new Product('5', 'Business Inkjet All In One Printer 752-DLLW-888',
        ...
        '07', 'Gadgets', 'Computers, Equipment',
    ...
    new Product('8', 'Optical Mouse Pro XS-85477PGT Carbon Black',
        ...
        '01', 'Gadgets', 'Computers, Equipment',
...
FeaturedProducts.map((product) => {
    ...
    product.images.map((image) => {
        ...
        galleryimgslide.innerHTML = `<img src="${image}"/>`;
    ...
    likeButton.onclick = () => {
        ...
        if (isLiked) {
            ...
            likes.push(product);
            newMessage(`Product added to likes <i class="fa-regular fa-heart"></i>`)
        }
